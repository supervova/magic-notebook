export const uk = {
  ...
  base: {
    ...
    downloadWindowsComingSoon: 'Windows — Випуск у червні',
    downloadWindowsComingSoonShort: 'Випуск у червні',
    footer: 'Підвал',
    getIt: 'Завантажити',
    getItWindows: 'Завантажити для Windows',
    logo: 'Логотип',
  ...
  nav: {
    ...
    supportTheProject: 'Підтримати проєкт',
