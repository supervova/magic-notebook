export const it = {
  ...
  supporters: {
    ...
    cardThreshold:
      'Da una donazione/acquisto di $100 — card profilo per un mese. Da $10 — avatar con info al passaggio del mouse. Ogni ulteriore contributo da 100 $ o 10 $ prolunga la pubblicazione di un altro mese.',
