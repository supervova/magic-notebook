export const ja = {
  ...
  options: {
    ...
    sponsorship: {
      title: 'スポンサー支援',
      cta: 'Patreonで支援',
      desc: 'アプリは今後も無料で提供されますが、Patreonでスポンサーになることもできます。✔️ アプリ本体と先行アクセス ✔️ 直接ダウンロード ✔️ 迅速なアップデート ✔️ サイト上のカードやアバター ✔️ +100カルマポイント が含まれます。',
    },
  },
  ...
  supporters: {
    ...
    cardThreshold:
      '$100以上の支援・購入で1か月間プロフィールカードを掲載。$10以上でホバー表示付きアバターを掲載します。',
