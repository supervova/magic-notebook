export const ko = {
  ...
  options: {
    ...
    sponsorship: {
      title: '스폰서 되기',
      cta: 'Patreon에서 후원',
      desc: '앱은 계속 무료로 제공되지만 Patreon에서 스폰서로 참여할 수 있습니다. ✔️ 앱과 얼리 액세스 ✔️ 직접 다운로드 ✔️ 빠른 업데이트 ✔️ 사이트 내 카드와 아바타 ✔️ +100 카르마 포인트가 포함됩니다.',
    },
  },
  ...
  supporters: {
    ...
    cardThreshold:
      '$100 이상 후원·구매 시 한 달간 프로필 카드가 표시됩니다. $10 이상이면 호버 패널이 있는 아바타가 추가됩니다.',
